...
CREATE TABLE IF NOT EXISTS student_syllabus_progress (
    ...
    exam_readiness_score REAL DEFAULT 65.0,
...
-- 11. Student Personal Timetable / Schedules
...
-- 15. Practice Tests & Performance Tracking
